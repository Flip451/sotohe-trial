...
- [ ] [AC-003] Application ports are located in use_cases; aggregate Repository ports remain in entities with their aggregates; HTTP controllers and DTO conversion are located in interface_adapters; persistence, cryptography, and axum server wiring are located in frameworks; assembly is located only in web_composition; and web remains a thin binary entry point. [adr: knowledge/adr/2026-09-12-0139-clean-architecture-layer-rename.md#D3, knowledge/adr/2026-09-12-0845-clean-architecture-aggregate-repository-placement.md#D1] [tasks: T003, T004, T005, T009, T006, T007, T008]
